...
const UsersTable = () => {
  ...
  const usersData = [
    { id: generateRandomId(), name: 'João', status: 'ativo', lastLogin: '2024-03-29', moneySpent: 150 },
    { id: generateRandomId(), name: 'Maria', status: 'inativo', lastLogin: '2024-03-28', moneySpent: 200 },
    { id: generateRandomId(), name: 'Pedro', status: 'ativo', lastLogin: '2024-03-27', moneySpent: 100 },
    { id: generateRandomId(), name: 'Calvin', status: 'ativo', lastLogin: '2024-03-29', moneySpent: 700 },
  ];
